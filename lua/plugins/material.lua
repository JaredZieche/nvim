return {
    {
        ...
        config = function()
            require("material").setup({
                plugins = {
                    "indent-blankline", "dashboard", "neogit", "nvim-cmp",
                    "nvim-navic", "nvim-tree", "nvim-web-devicons", "telescope",
                    "which-key", "trouble", "gitsigns"
                },
                contrast = {
                    ...
                    filetypes = { -- Specify which filetypes get the contrasted (darker) background
                        ...
                        "mason", "qf" -- Darker qf list background
                    }
                },
                high_visibility = {
